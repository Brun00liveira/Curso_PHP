...
<head>
    ...
    <body>
        ...
        <a href="../Projeto/Index.php" class="navbar-brand">
                <img src="../Img/564429.png" style="width: 50px;">
        ...
        <!-- Navegação -->
            <div class="collapse navbar-collapse mr-5" id="nav-target1">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a href="../Projeto/Index.php" class="nav-link text-light">Home</a>
                    </li>
                    <li class="nav-item">
                        <a href="../Projeto/st_calc.php" class="nav-link text-light">Calculadora</a>
                    </li>
                    <li class="nav-item dropdown">
                        <a href="../Projeto/Index.php" class="nav-link dropdown-toggle text-light" data-toggle="dropdown">Conversor</a>
                            <div class="dropdown-menu navbar-dark bg-info ">
                                <a href="../Projeto/moeda.php" class="dropdown-item bg-info text-light">Moeda</a>
                                <a href="../Projeto/wm_calc.php" class="dropdown-item bg-info text-light">Massa</a>
                                <a href="../Projeto/tmp_calc.php" class="dropdown-item bg-info text-light">Temperatura</a>
                                <a href="../Projeto/Time.php" class="dropdown-item bg-info text-light">Tempo</a>
                            </div>
                    </li>
                </ul>
            </div>
                ...
                <div class="row justify-content-md-center">
                    <div class="col-3">
                        <label style="margin-left:95px;" for="resultado" class="mt-4 form-label">Resultado</label>
                            <p name="resultado" class="form-control" id="resultado"><?php echo $num1.' '.$calcular.' '.$num2.' = '.$resultado ?></p>
                    </div>
